...
const enhancer = (Component: React.ComponentType<Props>) => (props: RouteComponentProps<any>) => {
  ...
  if (request.error === 'TIMEOUT') {
    message = 'Your transaction has not completed in time. This does not mean it has failed, please check the blockchain to confirm. (Note: Make sure you have 0.01 claimed TSG to pay the network transaction fee)';
